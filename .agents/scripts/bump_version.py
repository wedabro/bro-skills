...
Usage:
    python .agents/scripts/bump_version.py <new_version> [--push] [--skip-tests]

Examples:
    python .agents/scripts/bump_version.py 1.8.1
    python .agents/scripts/bump_version.py 1.8.1 --push
    python .agents/scripts/bump_version.py 1.8.1 --push --skip-tests
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python .agents/scripts/bump_version.py <new_version> [--push] [--skip-tests]")
        sys.exit(1)
